    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        http
            .authorizeExchange()
                ...
                .pathMatchers("/products").hasAnyRole("ADMIN", "CUSTOMER") // GET for both
                .pathMatchers("/products/**").hasRole("ADMIN") // POST/PUT/DELETE for ADMIN only
                .pathMatchers("/orders").hasAnyRole("ADMIN", "CUSTOMER") // GET for both
                .pathMatchers("/orders/**").hasRole("ADMIN") // POST/PUT/DELETE for ADMIN only
                //Fallback endpoint
